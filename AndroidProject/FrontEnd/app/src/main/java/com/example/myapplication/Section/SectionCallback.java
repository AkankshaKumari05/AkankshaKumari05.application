...
public class SectionCallback extends ItemTouchHelper.Callback {
    ...
    public SectionCallback(Context context, SectionedRecyclerViewAdapter adapter, OnActionHandler actionHandler) {
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE && isSectionViewHolder(viewHolder)) {
            viewHolder.itemView.setBackgroundColor(context.getColor(R.color.grey));
        }
    ...
    private boolean isSectionViewHolder(RecyclerView.ViewHolder viewHolder) {
        return viewHolder instanceof SectionView;
    }
    ...
    private boolean isFavoritesViewHolder(RecyclerView.ViewHolder viewHolder) {
        ...
        SectionView holder = (SectionView) viewHolder;
        return holder.getType().equals(SectionViewType.FAVORITES);
    }
}